...
const Footer = () => {
  return (
    <footer>
      <Holder className="w-full text-pink-600 py-6">
        <div className="flex items-center justify-center gap-6 mt-6">
          <a href="" className="hover:scale-105">
            <img src={image} className="w-[25px] h-[28px] " alt="" />
          </a>
          <a href="" className="hover:scale-105">
            <img src={image1} className="w-[25px] h-[28px] " alt="" />
          </a>
          <a href="" className="hover:scale-105">
            <img src={image2} className="w-[25px] h-[28px] " alt="" />
          </a>
          <a href="" className="hover:scale-105">
            <img src={image3} className="w-[25px] h-[28px]" alt="" />
          </a>
        </div>

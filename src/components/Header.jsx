...
const Header = ({value, valueChangerFn}) => {
  ...
  return (
    <section className="min-h-[680px] bg-center bg-cover" style={{ backgroundImage: `url(${bgImage})` }}>
      <Nav searchValue={value} handlerFn={valueChangerFn} />
      <Holder>
        <div className="max-w-72 flex flex-col gap-3 mt-14">
          ...
          <Link to={`/${banner.media_type}/${banner.id}`} className="w-[169px] h-9 rounded-md flex items-center bg-[#BE123C] gap-2 py-2 px-4 mt-6 mb-8">
